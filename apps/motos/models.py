...
class ModeloMoto(models.Model):
    tienda = models.ForeignKey('tiendas.Tienda', on_delete=models.CASCADE, related_name='modelos')
...
class PlanPrecio(models.Model):
    modelo = models.ForeignKey(ModeloMoto, on_delete=models.CASCADE, related_name='planes')
...
class CargoMoto(models.Model):
    modelo = models.ForeignKey(ModeloMoto, on_delete=models.CASCADE, related_name='cargos')
...
class FotoModelo(models.Model):
    modelo = models.ForeignKey(ModeloMoto, on_delete=models.CASCADE, related_name='fotos')
...
class Moto(models.Model):
    ...
    tienda = models.ForeignKey('tiendas.Tienda', on_delete=models.CASCADE, related_name='motos')
    modelo = models.ForeignKey(ModeloMoto, on_delete=models.PROTECT, related_name='motos')
